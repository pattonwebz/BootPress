...
function optionsframework_options() {
	...
	// Slider data
	$slider_array = array(
		'1' => __('One', 'bootstrap_framework'),
		'2' => __('Two', 'bootstrap_framework'),
		'3' => __('Three', 'bootstrap_framework'),
		'4' => __('Four', 'bootstrap_framework'),
		'5' => __('Five', 'bootstrap_framework')
	);
	...
	$options[] = array(
		'name' => __('Slider', 'bootpress_framework'),
		'type' => 'heading' );

		
	$options[] = array(
		'name' => __('Enable Slider', 'bootpress_framework'),
		'desc' => __('Turn on the Carousel', 'bootpress_framework'),
		'id' => 'enable_slider',
		'type' => 'checkbox');
		
	$options[] = array(
		'name' => __('Amount of Slides', 'bootpress_framework'),
		'desc' => __('The maximum amount of slides to show in the carousel.', 'bootpress_framework'),
		'id' => 'slider_limit',
		'std' => 'three',
		'type' => 'select',
		'class' => 'mini', //mini, tiny, small
